...
<head>
  ...
  <title><?php echo __('Tag'); ?> - <?php echo context::global_filters(dcCore::app()->ctx->meta->meta_id,array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'TagID'); ?> - <?php echo context::global_filters(dcCore::app()->blog->name,array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => '1',
  'cut_string' => 0,
...
<?php if (dcCore::app()->ctx->pagination->f(0) > dcCore::app()->ctx->posts->count()) : ?>
  ...
  <link rel="alternate" type="application/atom+xml" title="Atom 1.0" href="<?php echo context::global_filters(dcCore::app()->blog->url.dcCore::app()->url->getURLFor("tag_feed",rawurlencode(dcCore::app()->ctx->meta->meta_id)."/atom"),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  <header id="content-info">
    <h2><?php echo __('Tag'); ?> - <?php echo context::global_filters(dcCore::app()->ctx->meta->meta_id,array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'strip_tags' => 0,
    ...
    <p><a type="application/atom+xml" href="<?php echo context::global_filters(dcCore::app()->blog->url.dcCore::app()->url->getURLFor("tag_feed",rawurlencode(dcCore::app()->ctx->meta->meta_id)."/atom"),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'type' => 'atom',
      ...
      <?php if(dcCore::app()->blog->settings->system->allow_comments || dcCore::app()->blog->settings->system->allow_trackbacks) : ?>
        - <a type="application/atom+xml" href="<?php echo context::global_filters(dcCore::app()->blog->url.dcCore::app()->url->getURLFor("tag_feed",rawurlencode(dcCore::app()->ctx->meta->meta_id)."/atom"),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,

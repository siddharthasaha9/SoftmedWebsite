...
while (dcCore::app()->ctx->categories->fetch()) : ?>
  ...
  'strip_tags' => 0,
          ...
          <?php if(dcCore::app()->ctx->categories->nb_post > 0) : ?>
            <ul class="content-info__feed">
              <li><a type="application/atom+xml" href="<?php echo context::global_filters(dcCore::app()->blog->url.dcCore::app()->url->getURLFor("feed","category/".dcCore::app()->ctx->categories->cat_url."/atom"),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'type' => 'atom',
               ...
               title="<?php echo __('This category\'s entries Atom feed'); ?>" class="feed"><?php echo __('Entries feed'); ?></a></li>
  ...
  'type' => 'atom',
                 ...
                 title="<?php echo __('This category\'s comments Atom feed'); ?>" class="feed"><?php echo __('Comments feed'); ?></a></li>
              <?php endif; ?>
            </ul>
          <?php endif; ?>

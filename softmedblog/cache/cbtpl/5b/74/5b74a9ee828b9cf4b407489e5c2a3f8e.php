...
<?php while (dcCore::app()->ctx->posts->fetch()) : ?><a href="<?php echo context::global_filters(dcCore::app()->ctx->posts->getURL(),array (
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'EntryURL'); ?>"><time datetime="<?php echo context::global_filters(dcCore::app()->ctx->posts->getISO8601Date(''),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'strip_tags' => 0,
  'iso8601' => '1',
),'EntryDate'); ?>"><?php echo context::global_filters(dcCore::app()->ctx->posts->getDate('%e %B %Y',''),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'strip_tags' => 0,
  'format' => '%e %B %Y',
),'EntryDate'); ?></time></a><?php endwhile; dcCore::app()->ctx->posts = null; dcCore::app()->ctx->post_params = null; ?> <?php echo __('toDay'); ?> <?php if (dcCore::app()->ctx->exists("meta") && dcCore::app()->ctx->meta->rows() && (dcCore::app()->ctx->meta->meta_type == "tag")) { if (!isset($params)) { $params = []; }
if (!isset($params['from'])) { $params['from'] = ''; }
if (!isset($params['sql'])) { $params['sql'] = ''; }
$params['from'] .= ', '.dcCore::app()->prefix.'meta META ';
$params['sql'] .= 'AND META.post_id = P.post_id ';
...
<?php while (dcCore::app()->ctx->posts->fetch()) : ?><a href="<?php echo context::global_filters(dcCore::app()->ctx->posts->getURL(),array (
  ...
  'strip_tags' => 0,
  'format' => '%e %B %Y',
),'EntryDate'); ?></time></a><?php endwhile; dcCore::app()->ctx->posts = null; dcCore::app()->ctx->post_params = null; ?>
              </p>
...
<?php while (dcCore::app()->ctx->archives->fetch()) : ?>
                <?php if (dcCore::app()->ctx->archives->yearHeader()) : ?>
                  <div class="arch-by-year__each-year">
                    <h4><time datetime="<?php echo context::global_filters(dt::dt2str('%Y',dcCore::app()->ctx->archives->dt),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'strip_tags' => 0,
  'format' => '%Y',
),'ArchiveDate'); ?>"><?php echo context::global_filters(dt::dt2str('%Y',dcCore::app()->ctx->archives->dt),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'ArchiveDate'); ?>"><time datetime="<?php echo context::global_filters(dt::dt2str('%Y-%m',dcCore::app()->ctx->archives->dt),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,

...
<head>
	...
	<title><?php echo __('Archives'); ?> - <?php echo context::global_filters(dt::dt2str('%B %Y',dcCore::app()->ctx->archives->dt),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'ArchiveDate'); ?> - <?php echo context::global_filters(dcCore::app()->blog->name,array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => '1',
  'cut_string' => 0,
...
$params['type'] = 'month';
$params['next'] = dcCore::app()->ctx->archives->dt;dcCore::app()->ctx->archives = dcCore::app()->blog->getDates($params); unset($params);
?>
<?php while (dcCore::app()->ctx->archives->fetch()) : ?><link rel="next" href="<?php echo context::global_filters(dcCore::app()->ctx->archives->url(dcCore::app()),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'ArchiveDate'); ?>" /><?php endwhile; dcCore::app()->ctx->archives = null; ?>
	<?php
if (!isset($params)) $params = [];$params['type'] = 'month';
$params['previous'] = dcCore::app()->ctx->archives->dt;dcCore::app()->ctx->archives = dcCore::app()->blog->getDates($params); unset($params);
?>
<?php while (dcCore::app()->ctx->archives->fetch()) : ?><link rel="prev" href="<?php echo context::global_filters(dcCore::app()->ctx->archives->url(dcCore::app()),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
...
$params['previous'] = dcCore::app()->ctx->archives->dt;dcCore::app()->ctx->archives = dcCore::app()->blog->getDates($params); unset($params);
?>
<?php while (dcCore::app()->ctx->archives->fetch()) : ?><a href="<?php echo context::global_filters(dcCore::app()->ctx->archives->url(dcCore::app()),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'ArchiveURL'); ?>" class="prev">&#171; <?php echo context::global_filters(dt::dt2str('%B %Y',dcCore::app()->ctx->archives->dt),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => '1',
  'cut_string' => 0,
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'ArchiveDate'); ?></a> - <?php endwhile; dcCore::app()->ctx->archives = null; ?>
						<?php echo context::global_filters(dt::dt2str('%B %Y',dcCore::app()->ctx->archives->dt),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
...
<?php while (dcCore::app()->ctx->archives->fetch()) : ?> - <a href="<?php echo context::global_filters(dcCore::app()->ctx->archives->url(dcCore::app()),array (
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'ArchiveURL'); ?>" class="next"><?php echo context::global_filters(dt::dt2str('%B %Y',dcCore::app()->ctx->archives->dt),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => '1',
  'cut_string' => 0,
  ...
  'strip_tags' => 0,
					...
					<div id="content-info">
						<h2><?php echo context::global_filters(dt::dt2str('%B %Y',dcCore::app()->ctx->archives->dt),array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
  ...
  'capitalize' => 0,
  'strip_tags' => 0,
),'ArchiveDate'); ?> <span>(<?php echo context::global_filters(dcCore::app()->ctx->archives->nb_post,array (
  0 => NULL,
  'encode_xml' => 0,
  'encode_html' => 0,
  'cut_string' => 0,
